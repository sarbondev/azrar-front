...
const LanguageSwitcher = () => {
  ...
  // ✅ Mount bo'lgunicha har doim birinchi tilni ko'rsat
  ...
  return (
    <div className="relative mr-2">
          ...
          style={{
            background: mounted
              ? current.code === "uz"
                ? "#1DC45A"
                : "#005BFF"
              : "#1DC45A", // ✅ server bilan bir xil default
          }}
        />
        {mounted ? current.label : "UZ"} {/* ✅ server bilan bir xil default */}
        <svg
      ...
      {isOpen &&
        mounted && ( // ✅ mounted bo'lmasdan dropdown ochilmaydi
          <>
            <div
