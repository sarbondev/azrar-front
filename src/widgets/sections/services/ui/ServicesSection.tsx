...
const EngineeringServices = () => {
  ...
  if (!isMounted) {
    return (
      <section className="min-h-screen p-6 animate-pulse">
      ...
      <div className="bg-gray-50 py-12 sm:py-20 px-4 sm:px-6 lg:px-8 mt-20">
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-6 sm:px-8 py-3 sm:py-4 bg-white border-2 border-gray-300 text-gray-700 rounded-xl font-semibold hover:border-gray-400 transition-colors text-sm sm:text-base cursor-pointer">
              {t("services.learnMore")}
            </button>
            <button className="px-6 sm:px-8 py-3 sm:py-4 bg-gray-800 text-white rounded-xl font-semibold hover:bg-gray-900 transition-all shadow-lg text-sm sm:text-base cursor-pointer">
