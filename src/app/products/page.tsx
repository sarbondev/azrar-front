      ...
      <div className="border-b border-gray-100 sticky top-16 z-30 bg-white/90 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <button
            ...
            className="sm:hidden flex items-center gap-1.5 text-sm border border-gray-200 rounded-lg px-3 py-2 cursor-pointer"
          >
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-32 text-center">
            ...
            {search && (
              <button
                onClick={() => setSearch("")}
                className="mt-4 text-sm text-[#173F5F] underline cursor-pointer"
              >
